...
jQuery(document).ready(function() {
	...
	jQuery(window).scroll(function() {
		// jQuery(this).scrollTop() > 1 ? jQuery("nav:first").addClass("sticky-header") : jQuery("nav:last").removeClass("sticky-header")
		$( "nav" ).addClass(function( index, currentClass ) {
			var addedClass;
			
			if ( jQuery(this).scrollTop() && currentClass === "black" ) {
			  addedClass = "sticky-header";
			}else{
				removedClass = "sticky-header";
			}
