...
class CategoryProduct extends Controller
{
    ...
    public function show_category_home($CatID){
        ...
        ->where('tbl_product.CatID',$CatID)->get();
        
        $CateName = DB::table('tbl_categories')->where('tbl_categories.CatID',$CatID)->limit(1)->get();
        return view('pages.sanpham.show_category')->with('category',$cate_product)->with('brand',$tag_product)->with('category_by_id',$category_by_id)->with('CateName',$CateName);
    }
}
